        ...
        return (
            <div>
                <div className={styles.banner}>
                    <NavBar onLeftClick={() => router.goBack()}
                        mode="dark"
                        icon={<Icon type="left" />}
                        >我的
                    </NavBar>
